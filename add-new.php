...
<body style="background-image: url('https://i.ibb.co/x2T83HK/joanna-kosinska-7-ACu-Hoez-UYk-unsplash.jpg');">
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: transparent;">
    <span style="color: white; font-weight: bold;">CRUD Application</span>
  </nav>

   <div class="container">
      <div class="text-center mb-4 ", style="color: white; font-weight: bold;">
         <h3>Add New User</h3>
